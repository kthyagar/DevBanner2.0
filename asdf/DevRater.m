...
- (void)show{
    ...
    ImageView2 = [[UIImageView alloc] initWithFrame:CGRectMake([[UIScreen mainScreen] bounds].size.width*.1,[[UIScreen mainScreen] bounds].size.height*.2, [[UIScreen mainScreen] bounds].size.width*.8, [[UIScreen mainScreen] bounds].size.height*.6)];
    [ImageView2 setBackgroundColor:[UIColor blackColor]];
    ImageView2.layer.cornerRadius = 17;
    ImageView2.clipsToBounds = YES;
    
    ImageView3 = [[UIImageView alloc] initWithFrame:CGRectMake([[UIScreen mainScreen] bounds].size.width*.1+4,[[UIScreen mainScreen] bounds].size.height*.2+4, [ImageView2 bounds].size.width-8, [ImageView2 bounds].size.height-8)];
    [ImageView3 setBackgroundColor:[UIColor darkGrayColor]];
    ...
    label2a = [[UILabel alloc] initWithFrame:CGRectMake([[UIScreen mainScreen] bounds].size.width*.1+4,[[UIScreen mainScreen] bounds].size.height*.5, [ImageView2 bounds].size.width-8, 20)];
    ...
    star1 = [[UIButton alloc] initWithFrame:CGRectMake([[UIScreen mainScreen] bounds].size.width*.5-123,[[UIScreen mainScreen] bounds].size.height*.7, 46, 46)];
    star2 = [[UIButton alloc] initWithFrame:CGRectMake([[UIScreen mainScreen] bounds].size.width*.5-73,[[UIScreen mainScreen] bounds].size.height*.7, 46, 46)];

    star3 = [[UIButton alloc] initWithFrame:CGRectMake([[UIScreen mainScreen] bounds].size.width*.5-23,[[UIScreen mainScreen] bounds].size.height*.7, 46, 46)];

    star4 = [[UIButton alloc] initWithFrame:CGRectMake([[UIScreen mainScreen] bounds].size.width*.5+27,[[UIScreen mainScreen] bounds].size.height*.7, 46, 46)];
    star5 = [[UIButton alloc] initWithFrame:CGRectMake([[UIScreen mainScreen] bounds].size.width*.5+77,[[UIScreen mainScreen] bounds].size.height*.7, 46, 46)];
    ...
    label2a.text=@"Tell us how you like the app!";
